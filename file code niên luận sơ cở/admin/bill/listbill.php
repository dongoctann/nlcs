<body class="bodycart">
    <div class="container containercart">
        ...
        <table>
            ...
            <?php
            // Lặp qua mỗi hóa đơn trong danh sách hóa đơn
            foreach ($listbill as $bill) {
                // Trích xuất các giá trị từ mỗi hóa đơn để sử dụng dễ dàng
                extract($bill);
                // Tạo biến $kh chứa thông tin của khách hàng
                $kh = $bill['bill_name'] . '
        <br>' . $bill["bill_email"] . '
        ...
        <br>' . $bill["bill_tel"];
                ...
                // Đếm số lượng sản phẩm trong giỏ hàng của đơn hàng hiện tại
