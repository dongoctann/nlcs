                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                            <li class="nav-item active"> <a href="index.php?act=admin" class="nav-link">Trang Chủ</a></li>
                            <li class="nav-item active"> <a href="index.php?act=addsp" class="nav-link">Thêm Sản Phẩm</a></li>
                            <li class="nav-item"><a href="./index.php?act=lisdm" class="nav-link" data-bs-toggle="modal">Thêm Danh Mục</a> </li>
                            <li class="nav-item"><a href="./index.php?act=listsp" class="nav-link" data-bs-toggle="modal">Danh Sách Sản Phẩm</a> </li>
                            <li class="nav-item"><a href="./index.php?act=dskh" class="nav-link" data-bs-toggle="modal">Danh Sách Khách Hàng</a> </li>
