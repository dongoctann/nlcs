        ...
        <div class="containerdh">
            <div class="row">
                <div class="row mb">
                    ...
                    <?php
                    // Kiểm tra xem biến $bill đã được khai báo và có phải là một mảng không
                    if (isset($bill) && (is_array($bill))) {
                        // Nếu $bill tồn tại và là một mảng, trích xuất các biến từ mảng $bill để sử dụng
                        extract($bill);
                    }
                    ?>
